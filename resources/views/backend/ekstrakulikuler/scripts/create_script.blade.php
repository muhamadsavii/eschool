<script>
    ...
    $(document).on('click', '#save_ekstrakulikuler', function(event){
        ...
        var dataForm = $("#ekstrakulikuler-create-form").serializeArray();
        var base_url = {!! json_encode(url('/')) !!};
        $.ajax({
            url: base_url +'/ekstrakulikuler/store',
            type: "GET",
            data: dataForm,
            async:true,
            processData: true,
    ...
    $(document).on('click', '#edit_ekstrakulikuler', function(event){
        // alert('tes');
        //mencegah multiple post -->
        var me = $(this);
        event.preventDefault();
        ...
        var base_url = {!! json_encode(url('/')) !!};
        $.ajax({
            url: base_url +'/ekstrakulikuler/update/'+id,
            type: "GET",
            data: dataForm,
            async:true,
            processData: true,
