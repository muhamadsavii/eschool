<script>
    $(document).ready(function(){
        ...
        */
        ...
        function getFormImage(){
            ...
            $.get( base_url +'/galeri/form_image/1', function( data ) {
    ...
    $(document).on('click', '#save_galeri', function(event){
        ...
        var dataForm = $("#galeri-create-form").serializeArray();
        var base_url = {!! json_encode(url('/')) !!};
        $.ajax({
            url: base_url +'/galeri/store',
            type: "GET",
            data: dataForm,
            async:true,
            processData: true,
    ...
    $(document).on('click', '#edit_galeri', function(event){
        // alert('tes');
        //mencegah multiple post -->
        var me = $(this);
        event.preventDefault();
